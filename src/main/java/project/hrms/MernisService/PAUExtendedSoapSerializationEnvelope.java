...
public class PAUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PAUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PAUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PAUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PAUDateTimeConverter dateTimeConverter = new PAUStandardDateTimeConverter();

    public PAUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PAUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PAUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PAUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PAUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PAUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
