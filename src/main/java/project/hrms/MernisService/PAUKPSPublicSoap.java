...
public class PAUKPSPublicSoap
{
    ...
    public PAUKPSPublicSoap(){}

    public PAUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PAUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PAUExtendedSoapSerializationEnvelope envelope= new PAUExtendedSoapSerializationEnvelope(PAUExtendedSoapSerializationEnvelope.VER11);
